...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}Sabadell, Spain}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+34-639-41-25-89}{{\footnotesize\faPhone*}\hspace*{0.13cm}+34 649 41 25 89}}%
        \kern 0.25 cm%
        %\AND%
        %\kern 0.25 cm%
    ...
    \section{Profile}
        \begin{onecolentry}
            Passionate and highly motivated \textbf{Computer Science student} at the Barcelona School of Informatics (UPC), with a strong academic record and a keen interest in data science, high-performance computing, and algorithm design.
        \end{onecolentry}
