...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://lluc24.github.io/}{{\footnotesize\faLink}\hspace*{0.13cm}lluc24.github.io}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
    ...
    \section{Profile}
        \begin{onecolentry}
            Computer Science student at UPC (ranked 1st of 400, GPA 9.25/10), currently on exchange at EPFL. Interested in machine learning, algorithms, and financial markets. Proven strengths in leadership, problem-solving and organization.
        \end{onecolentry}
    ...
    \section{Projects}
        \begin{twocolentry}{
            \href{https://bit.ly/suiHack}{bit.ly/suiHack}
        }
        ...
        \begin{twocolentry}{
            \href{https://bit.ly/hackUPC}{bit.ly/hackUPC}
        }
            \textbf{Snap2Shop}, HackUPC Hackathon, Inditex Challenge
            \begin{highlights}
                \item Computer Vision solution for visual search of fashion clothes
                \item Mobile app built with Flutter, FastAPI and Inditex API
            \end{highlights}
        \end{twocolentry}
